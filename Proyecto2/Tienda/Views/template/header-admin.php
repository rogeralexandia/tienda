...
//echo "Config loaded"; // Punto de depuración

// Verificar si las constantes están definidas
/*if (defined('BASE_URL')) {
    echo "BASE_URL: " . BASE_URL; // Punto de depuración
} else {
    die('BASE_URL no está definida');
}*/
// Resto del código...
    ...
    <div id="wrapper">
        ...
        <div class="left side-menu">
            ...
            <div class="left-side-logo d-block d-lg-none">
                <div class="text-center">
                    <a href="index.html" class="logo"><img src="<?php echo BASE_URL; ?>public/img/factory.jpeg" height="20" alt="logo"></a>
                </div>
            </div>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <!-- Contenido de la página de devoluciones -->
