  ...
  <div>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="<?php echo BASE_URL; ?>public/img/factory.jpeg" alt="" width="150"></a>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="<?php echo BASE_URL; ?>"><img src="<?php echo BASE_URL; ?>public/img/factory.jpeg" alt="LOGO" width="150"></a>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <?php if ($data['title'] == 'Pagina Principal') { ?>
                        <div class="hero__item set-bg" data-setbg="<?php echo BASE_URL; ?>public/img/hero/banner1.jpg">
                            <div class="hero__text">
                                <span>TIENDA DIGITAL</span>
                                <h2>Garantia<br />100% Original</h2>
